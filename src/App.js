...
import './App.css';
import MainContent from './AppComponent/MainContent';
...
class App extends Component {
  ...
  handleClick(e) {
    ...
    if (!this.state.enableClick) {
      this.setState((prevState) => {
        return { 
          enableClick: !prevState.enableClick
        }
      });
      setTimeout(() => {
        this.setState((prevState) => {
          return { 
            isShowContentComponent: !prevState.isShowContentComponent
          }
        });
      }, //5600
      0 
  ...
  render() {
    let animationClasses = (this.state.enableClick ? 'active' : '');
    return (
      <div className="app-wrapper">
        {!this.state.isShowContentComponent ?
        <div className="content-wrapper">
          <div className="object">
            <div className="object__intro">
              <h1 className="object__intro-title">Click here</h1>
              <p className="object__intro-text">Many interesting things are waiting for you!</p>
            </div>
            <div className="arrow">
          ...
          <div className={`button-wrapper ${animationClasses}`} onClick={this.handleClick}>
